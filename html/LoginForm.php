<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $check=$val->fetch_array(MYSQLI_ASSOC);
    ...
    }else
    {
            if(password_verify($password, $pass))
            {
                ...
                header('location:availClasses.php');
            }else
            {
                echo '<script>alert("Invalid Username Or Password");
                </script>';
...
<html lang="en">
  <head>
    ...
    <div class="login-form">    
        ...
        <div class="text-center small">Don't have an account? <a href="StudentForm.php">Sign up</a></div>
    </div>
    </body>
    </html>